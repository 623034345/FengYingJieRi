...
@interface FYJTextViewController ()<YYTextViewDelegate, YYTextKeyboardObserver>
...
@implementation FYJTextViewController
...
- (void)viewDidLoad {
    ...
    NSMutableAttributedString *text = [[NSMutableAttributedString alloc] initWithString:@"江雪 柳宗元 千山鸟飞绝， 万径人踪灭。 孤舟蓑笠翁， 独钓寒江雪。"];
