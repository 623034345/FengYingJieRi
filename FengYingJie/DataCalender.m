...
- (instancetype)init {
    if (self = [super init]) {
        ...
        [self setFrame:CGRectMake(0,0, WIDTH,self.collectionView.frame.size.height + CollectionViewVerticalMargin *2)];
        _date = [NSDate date];
    }
    return self;
}
...
- (void)setupCollectionView {
    CGFloat itemWidth = (WIDTH -CollectionViewHorizonMargin *2) / 7;
    ...
    CGRect collectionViewFrame = CGRectMake(CollectionViewHorizonMargin,CollectionViewVerticalMargin,WIDTH - CollectionViewHorizonMargin *2, itemHeight *6);
...
//        //选中了某一天
//        if (day == [[NSCalendar currentCalendar] component:NSCalendarUnitDay fromDate:self.selectedDate]) {
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(calendarItem:didSelectedDate:)]) {
        [self.delegate calendarItem:self didSelectedDate:_selectedDate];
    }
}
